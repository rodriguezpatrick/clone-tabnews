...
describe("GET /api/v1/users/user", () => {
  ...
  describe("Default user", () => {
    test("With valid session", async () => {
      ...
      const responseBody = await response.json();
      console.log("Response Body:", responseBody); // Log para depuração
      expect(responseBody).toEqual({
        id: createdUser.id,
        username: "UserWithValidSession",
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "f0b62a5ff97ae607701ceeee2e3c4987c4b9debb534410e2444f9eb2288b6e3b9015a71d086e31eabef9b36cbb549e1";
    ...
    test("with a session that’s about to expire", async () => {
      jest.useFakeTimers({
        now: new Date(
